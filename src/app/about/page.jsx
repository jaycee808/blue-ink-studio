...
export default function AboutHero() {
    return (
        ...
        <div className="about-container two-col">
            ...
            <h2 className="section-title intro-title subheader">Turning Ideas into Identities</h2>

            <div className="intro-stack">
                <p className="intro-text text-body">Blue Ink Studio is built on thoughtful design and development.</p>
                <p className="intro-text text-body">
            ...
            <div className="about-cta">
                <Link href="/portfolio" className="about-btn-cta btn-text" aria-label="View my portfolio">
            ...
            <section className="about-block">
                ...
                <span className="block-number text-label">01</span>
                <h3 className="block-title section-heading">About Me</h3>
                </header>
                <p className="block-body text-body">
            ...
            <section className="about-block">
                <header className="block-head">
                <span className="block-number text-label">02</span>
                <h3 className="block-title section-heading">My Approach</h3>
                </header>
                ...
                <div className="approach-card">
                    <h4 className="approach-title section-heading">Structured</h4>
                    <p className="approach-desc text-body">
                ...
                <div className="approach-card">
                    <h4 className="approach-title section-heading">Intentional</h4>
                    <p className="approach-desc text-body">
                ...
                <div className="approach-card">
                    <h4 className="approach-title section-heading">Bold</h4>
                    <p className="approach-desc text-body">
            ...
            <section className="about-block">
                <header className="block-head">
                <span className="block-number text-label">03</span>
                <h3 className="block-title section-heading">Tools</h3>
                </header>
                <p className="block-body text-body">

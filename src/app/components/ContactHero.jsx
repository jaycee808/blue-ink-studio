...
export default function ContactSection() {
    return (
        ...
        <div className="contact-container">
            <span className="contact-section-label text-label">CONTACT</span>
            <h2 className="section-title-contact section-heading-lrg">Ready to bring your ideas to life?</h2>

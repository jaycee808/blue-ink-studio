...
export default function Atlas() {
    return (
        ...
        <div className="caseStudy-block">
            ...
            <ul className="text-list">{cs.designProcess.designDecisions.map((d, i) => <li key={i}>{d}</li>)}</ul>
            <h3 className="section-heading">Accessibility</h3>
            <ul className="text-list">{cs.designProcess.accessibility.map((a, i) => <li key={i}>{a}</li>)}</ul>
        </div>
        ...
        <div className="caseStudy-block">
            ...
            <ul className="text-list">{cs.developmentProcess.techStack.map((t, i) => <li key={i}>{t}</li>)}</ul>
            <h3 className="section-heading">Features Built</h3>
            <ul className="text-list">{cs.developmentProcess.featuresBuilt.map((f, i) => <li key={i}>{f}</li>)}</ul>
            <h3 className="section-heading">Challenges Solved</h3>
            <ul className="text-list">{cs.developmentProcess.challengesSolved.map((c, i) => <li key={i}>{c}</li>)}</ul>
        </div>

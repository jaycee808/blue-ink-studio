        ...
        <div className="caseStudy-block">
            ...
            {cs.finalOutcome?.screenshots && (
                ...
                <div
                    ...
                    role="list"
                    aria-label="Metrica screenshots carousel"
                >
                    {/* Hero */}
                    ...
                    {/* Collections */}
                    <article className="screenshot-card" role="listitem" tabIndex={0}>
                    <figcaption className="text-label">Collections</figcaption>
                    <figure className="screenshot-viewport">
                        <img
                        src={cs.finalOutcome.screenshots.collections}
                        alt="Metrica Collections Page"
                        loading="lazy"
                        />
                    </figure>
                    </article>
                    ...
                    {/* Collection */}
                    <article className="screenshot-card" role="listitem" tabIndex={0}>
                    <figcaption className="text-label">Collection</figcaption>
                    <figure className="screenshot-viewport">
                        <img
                        src={cs.finalOutcome.screenshots.collection}
                        alt="Metrica Single Collection Page"
                        loading="lazy"
                        />
                    </figure>
                    </article>
                    ...
                    {/* Gallery */}
                    <article className="screenshot-card" role="listitem" tabIndex={0}>
                    <figcaption className="text-label">Gallery</figcaption>
                    <figure className="screenshot-viewport">
                        <img
                        src={cs.finalOutcome.screenshots.gallery}
                        alt="Metrica Gallery Page"
                        loading="lazy"
                        />
                    </figure>
                    </article>
